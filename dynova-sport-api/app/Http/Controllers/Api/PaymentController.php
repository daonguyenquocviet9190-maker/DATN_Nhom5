...
class PaymentController extends Controller
{
    ...
    {
        try {
            $state = $this->payments->provider()->stateForOrder((int) $id, (int) $request->user()->id);
    ...
    {
        try {
            $state = $this->payments->provider()->refreshForOrder((int) $id, (int) $request->user()->id);
    ...
    {
        try {
            $result = $this->payments->vietqr()->webhook(
                $request->all(),
