...
export default function AdminBannersPage() {
  ...
  const openEdit=(i)=>{setEditing(i); setForm({title:i.title||"",subtitle:i.subtitle||i.tagline||"",description:i.description||"",button_text:i.cta_text||i.button_text||i.buttonText||"Mua sắm ngay",button_link:i.cta_link||i.button_link||i.buttonLink||"/shop",sort_order:i.sort_order||i.sortOrder||1,is_active:i.is_active!==false&&i.is_active!==0,image:null}); setOpen(true)};
