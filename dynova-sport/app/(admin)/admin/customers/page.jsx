...
export default function AdminCustomersPage() {
  ...
  const loadData = async () => {
    try {
      ...
      setError(err?.message || "Không thể tải khách hàng. Cần có API /api/admin/customers.");
      setCustomers([]);
