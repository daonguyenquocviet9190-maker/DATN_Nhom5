...
const LABELS = {
  ...
  money_collect_delivering: "Đang giao và thu hộ",
  delivered: "Giao hàng thành công",
  delivery_fail: "Giao hàng chưa thành công",
  waiting_to_return: "Đang chờ xử lý giao lại",
  return: "Đang chuẩn bị hoàn hàng",
  return_transporting: "Hàng hoàn đang trung chuyển",
  return_sorting: "Hàng hoàn đang phân loại",
  returning: "Đang hoàn về người gửi",
  return_fail: "Hoàn hàng chưa thành công",
  returned: "Đã hoàn hàng",
  cancel: "Vận đơn đã hủy",
  exception: "Đang xử lý ngoại lệ",
  damage: "Hàng hóa được ghi nhận hư hỏng",
  lost: "Hàng hóa được ghi nhận thất lạc",
};

const DESCRIPTIONS = {
  ready_to_pick: "Đơn vị vận chuyển đã tiếp nhận thông tin vận đơn.",
  picking: "Nhân viên GHN đang di chuyển đến điểm lấy hàng.",
  picked: "Kiện hàng đã được bàn giao cho GHN.",
  storing: "Kiện hàng đã được nhập vào kho vận chuyển.",
  transporting: "Kiện hàng đang di chuyển giữa các trung tâm khai thác.",
  sorting: "Kiện hàng đang được phân loại để chuyển tới khu vực giao.",
  delivering: "Shipper đang trên đường giao kiện hàng tới địa chỉ nhận.",
  delivered: "Người nhận đã nhận kiện hàng thành công.",
...
export default function OrderTrackingTimeline({
  ...
  const expected =
    tracking?.expected_delivery_time ||
    tracking?.leadtime ||
    order?.ghn_expected_delivery_at;
                      ...
                      <div>
                        <p
                          className={`text-sm font-black ${
                            index === 0 ? "text-indigo-700" : "text-slate-800"
                          }`}
                        >
                          {e.title}
                        </p>
